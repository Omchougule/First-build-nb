    ...
    <>
     <section className="py-28">
                <div className="max-w-screen-xl mx-auto  text-gray-600 gap-x-12 items-center justify-between overflow-hidden md:flex md:px-8" >
                    <div className="flex-none space-y-5 px-4 sm:max-w-lg md:px-0 lg:max-w-xl" data-aos="fade-right"  >
                        ...
                        <div className="items-center gap-x-3 space-y-3 sm:flex sm:space-y-0">
                            <a href="javascript:void(0)" className="block py-2 px-4 text-center text-white font-medium bg-green-600 duration-150 hover:bg-green-500 active:bg-green-700 rounded-lg shadow-lg hover:shadow-none">
                                Let's get started
                            </a>
                    ...
                    <div className="flex-none mt-14 md:mt-0 md:max-w-xl" data-aos="fade-left">
                        <img
                            // src="https://demo7.clientica.org/wp-content/uploads/2020/12/Image-1.jpg"
                            src="https://demo7.clientica.org/wp-content/uploads/2020/12/Image-1.png"
