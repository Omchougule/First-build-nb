          ...
          <div className="lg:w-4/5 mx-auto flex flex-wrap justify-center">
            ...
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              ...
              <div className="flex">
                ...
                <Link to={`/reciept/${id}`}>
                  <button className="inline-flex text-white bg-green-500 border-0 py-2 px-6 focus:outline-none hover:bg-green-600 rounded ">Buy Now</button>
                </Link>
