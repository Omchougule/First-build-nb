...
export default function NotFound() {
    return (
        <>
            ...
            <div className="max-w-[50rem] flex flex-col mx-auto size-full mt-20">

                <header className="mb-auto flex justify-center z-50 w-full py-4">
                    <nav className="px-4 sm:px-6 lg:px-8" aria-label="Global">
                        <a className="flex-none text-xl font-semibold sm:text-3xl" href="#" aria-label="Brand">Nutribites</a>
                    </nav>
                </header>
                ...
                <main id="content">
                    <div className="text-center py-10 px-4 sm:px-6 lg:px-8">
                        ...
                        <div className="mt-5 flex flex-col justify-center items-center gap-2 sm:flex-row sm:gap-3">
                            <Link className="w-full sm:w-auto py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-green-600 text-white hover:bg-green-700 disabled:opacity-50 disabled:pointer-events-none" to="/">
