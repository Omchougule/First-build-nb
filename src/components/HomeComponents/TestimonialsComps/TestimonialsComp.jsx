    ...
    return (
        ...
        <div className='bg-[#f76d3c] h-screen    flex justify-center flex-col 
          '>
            ...
            <div>
                <img className=' shade hidden md:block md:-translate-y-48 rotate-180  ' src='https://dt-faryita.myshopify.com/cdn/shop/files/after_image-orange_top.png?v=1657021307' alt="" />
            </div>

            <div className=' flex flex-col space-y-10     justify-center items-center'>
                <h1 className='font-hand text-4xl'>Testimonials</h1>
