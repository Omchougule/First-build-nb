    ...
    return (
        <div className='bg-[#b4c817]     flex justify-center flex-col 
          '  >
            ...
            <div>
                <img className=' hidden md:block md:-translate-y-24 ' src='https://dt-faryita.myshopify.com/cdn/shop/files/bgimg24_98fe6de9-83dd-40b2-95ff-537503fbebf9.png?v=1657021064' alt="" />
            </div>
