...
const SpecialItems = () => {
  return (
    <div className='bg-[#ff679a] h-screen   flex justify-center flex-col 
          '>
            ...
            <div>
                <img className=' hidden md:block md:-translate-y-48 ' src='https://dt-faryita.myshopify.com/cdn/shop/t/6/assets/background2.svg?v=90659865673969550361712826037' alt="" />
            </div>
