                    ...
                    <div className="mt-6 grid grid-cols-1 gap-4 md:grid-cols-2">
                        ...
                        <div className="flex justify-center mt-6">
                            <Link to="confirmation">
                                <button className="w-full rounded-lg bg-green-700 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-green-800 focus:outline-none focus:ring-4 focus:ring-green-300 light:bg-green-600 light:hover:bg-green-700 light:focus:ring-green-800 sm:w-auto">
                                    Place Your Order
                                </button>
                            </Link>
                        </div>
