...
export default function Contact() {
  ...
  const handleContact = async (e) => {
    ...
    const res = await axios.post('http://localhost:5000/contact',{email, message})
    if(res.data.success)
    {
    ...
    <div data-scroll-container>
      ...
      <section className="text-gray-600 body-font relative">
        ...
        <div className="container px-5 py-24 mx-auto flex">
          <form onSubmit={handleContact} className="lg:w-1/3 md:w-1/2 lg:me-20 bg-white rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0 relative z-10 shadow-md">
            ...
            <button type='submit' className="text-white bg-green-500 border-0 py-2 px-6 focus:outline-none hover:bg-green-600 rounded text-lg">Button</button>
