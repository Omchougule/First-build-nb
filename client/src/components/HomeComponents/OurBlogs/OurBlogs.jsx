                            ...
                            <div className="grid grid-cols-1 gap-12 lg:grid-cols-3 md:grid-cols-1   mx-auto">
                                <div className="p-4 ">
                                    <div className="h-full  shadow-lg border-opacity-60  rounded-lg overflow-hidden">
                                        ...
                                        <div className="p-6">
                                            ...
                                            <h1 className="title-font text-3xl font-medium text-gray-900 mb-3 font-hand">The Catalyzer</h1>
                                ...
                                <div className="p-4 ">
                                    <div className="h-full shadow-lg border-opacity-60 rounded-lg overflow-hidden">
                                        ...
                                        <div className="p-6">
                                            <h2 className="tracking-widest text-xs title-font font-medium text-gray-400 mb-1">CATEGORY</h2>
                                            <h1 className="title-font text-3xl font-medium text-gray-900 mb-3 font-hand">The 400 Blows</h1>
                                            <p className="leading-relaxed mb-3">Photo booth fam kinfolk cold-pressed sriracha leggings jianbing microdosing tousled waistcoat.</p>
                                            <div className="flex items-center flex-wrap">
                                                <a className="text-indigo-500 inline-flex items-center md:mb-2 lg:mb-0">Learn More
                                                    <svg className="w-4 h-4 ml-2" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round">
                                ...
                                <div className="p-4 ">
                                    <div className="h-full shadow-lg rounded-lg overflow-hidden">
                                        ...
                                        <div className="p-6">
                                            <h2 className="tracking-widest text-xs title-font font-medium text-gray-400 mb-1">CATEGORY</h2>
                                            <h1 className="title-font text-3xl font-medium text-gray-900 mb-3 font-hand">Shooting Stars</h1>
                                            <p className="leading-relaxed mb-3">Photo booth fam kinfolk cold-pressed sriracha leggings jianbing microdosing tousled waistcoat.</p>
                                            <div className="flex items-center flex-wrap ">
                                                <a className="text-indigo-500 inline-flex items-center md:mb-2 lg:mb-0">Learn More
                                                    <svg className="w-4 h-4 ml-2" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round">
