    ...
    return (
        <>
            ...
            {/* <div className="xl:w-1/3 md:w-1/2 p-4">
                <div className="border border-gray-200 p-6 rounded-lg shadow-md hover:animate-wiggle ">
            ...
            <li  className="bg-white rounded-xl border shadow-md hover:animate-wiggle" >
                <div className="p-4">
                ...
                <figure>
                    ...
                    <div className="flex items-center gap-x-4 p-4 mt-6 bg-green-50">
                        <img src={userPhoto} className="w-16 h-16 rounded-full border-2 border-green-500" />
                        <div>
                            <span className="block text-gray-800 font-semibold">{name}</span>
                            <span className="block text-green-600 text-sm mt-0.5">User</span>
                        </div>
                    </div>
                </figure>
            </li>
